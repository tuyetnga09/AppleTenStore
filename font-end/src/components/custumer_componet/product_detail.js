                ...
                <div className="chitietSanpham" style={{marginBottom: 100}}>
                    ...
                    <div className="rowdetail group">
                        ...
                        <div className="slide-container">
                            ...
                            <div className="small-picture" onClick={() => setValueForImageTemp(listImages.at(index)?.name)}>
                                <img src={`/imageUpload/` + listImages.at(index)?.name} alt=""/>
                            </div>
                            {
                                index < listImages.length - 1 ? (
                                    <div className="small-picture" onClick={() => setValueForImageTemp(listImages.at(index + 1)?.name)}>
                                        <img src={`/imageUpload/${listImages.at(index+1)?.name}`} alt=""/>
                                    </div>
                                ) : (
                                    <div className="small-picture" onClick={() => setValueForImageTemp(listImages.at(0)?.name)}>
