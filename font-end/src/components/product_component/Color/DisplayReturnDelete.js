...
import { returnDeleteAll, returnColor } from "../../../service/color.service";
...
import Pagination from "../Color/PageNext";
...
const ReturnDeleteColor = () => {
  ...
  async function handleDelete(id) {
    returnColor(id).then(() => {
      let newArr = [...color].filter((s) => s.id !== id);
      setColor(newArr);
    });
  }
                ...
                <div class="container">
                  <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-4">
                      <h2 class="heading-section">Màu Sắc Đã Xoá</h2>
                    </div>
                  </div>
                  <div class="row">
                    <div class="row"></div>
                    <div class="col-md-12">
                      <form class="d-flex" role="search">
                        ...
                        <button
                          type="button"
                          class="btn btn-outline-success"
                          onClick={() => handleDownload(color, "color")}
                        >
...
export default ReturnDeleteColor;
