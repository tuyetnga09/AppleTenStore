...
import {add as addColor, getCodeColor} from "../../../../service/color.service";
import {add as addChip, getCodeChip} from "../../../../service/chip.service";
import {add as addSize, getCodeSize} from "../../../../service/size.service";
import {createCapacity, getCodeCapacity} from "../../../../service/capacity.service";
import {createRam, getCodeRam} from "../../../../service/ram.service";
import {createManufacture, getCodeManufacture} from "../../../../service/manufacture.service";
import {add as addBattery, getCodeBattery} from "../../../../service/battery.service";
import {createCategory, getCodeCategory} from "../../../../service/category.service";
...
const Test = (setDisplay, setPagination) => {
    ...
    useEffect(() => {
        if (storedUser?.roles === "CUSTOMER" || storedUser === null) {
            ...
            getCodeBattery().then((response) => {
                setBatteryCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeCapacity().then((response) => {
                setCapacityCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeCategory().then((response) => {
            ...
            getCodeColor().then((response) => {
                setColorCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeManufacture().then((response) => {
                setManufactureCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeRam().then((response) => {
                setRamCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeScreen().then((response) => {
                setScreenCodes(response.data)
            }).catch((error) => {
                console.log(error)
            })

            getCodeSize().then((response) => {
