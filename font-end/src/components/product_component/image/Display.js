...
import {readAll, deleteImage} from "../../../service/image.service";
        ...
        <section style={{marginLeft: '50px'}}>
            <div class="row justify-content-center">
                <div class="col-md-3 text-center mb-3">
                    <h2 class="heading-section">Image</h2>
                </div>
            </div>
            <div class="row">
                <div class="row">
                        ...
                        <table class="table">
                            ...
                            {images.map((image) => (
                                <tr class="alert" role="alert" key={image.id}>
                                    ...
                                    <td>{image.code}</td>
                                    <td>
                                        <img src={image.link} width="100px" height="100px" alt=""/>
                                    </td>
                                    <td>{image.name}</td>
                                    <td>{image.status === 0 ? "Hoạt động" : "Không hoạt động"}</td>
                                    <td>
                                        <button
                                            type="button"
                                            class="close"
