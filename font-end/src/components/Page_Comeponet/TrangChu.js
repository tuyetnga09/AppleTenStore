      ...
      <>
        ...
        <section>
          ...
          <div class="companyMenu group flexContain">
            <a href="index.html?company=Apple">
          ...
          <div className="flexContain">
            ...
            <div className="sortFilter dropdown">
              ...
              <div class="dropdown-content">
                ...
                <a href="index.html?sort=rateCount-ascending">
                  Đánh giá tăng dần
                </a>
                <a href="index.html?sort=rateCount-decrease">
                  Đánh giá giảm dần
                </a>
              ...
              <div className="listSpTrongKhung flexContain">
                ...
                <li className="sanPham">
                  <a href="chitietsanpham.html?Mobiistar-B310">
                    <img
                      src="img/products/mobiistar-b310-orange-600x600.jpg"
                      alt=""
                    />
